...
from apps.users.utils import incrementId, get_url_by_idUrl
from .models import User, Url, GeradorID
from .schemas import UserRegistrationSchema, UserSchema, UserRegistrationUrlSchema, UrlSchema, GeradorIDSchema
    ...
    def post(self, *args, **kwargs):
        ...
        try:
            ...
            if not isinstance(dataLocal, Url):
                dataLocal = {"idUrl": 0, "hits": 0, "short_url": ""}
